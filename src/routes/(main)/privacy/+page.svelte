...
<div class="min-h-screen max-w-screen-xl mx-auto p-4 py-8">
	<div class="max-w-3xl mx-auto">
		...
		<div class="prose prose-slate max-w-none">
			...
			<p>4.1. Stored Data</p>
			<p>Since the Service can be self-hosted, you are responsible for:</p>
			<ul class="list-disc pl-6 mb-4">
			...
			<p>
				As a self-hosted solution, any international data transfers are under your control and responsibility. You
				should ensure compliance with relevant data protection laws when transferring data across borders.
			</p>
			...
			<p>
				For questions about this Privacy Policy, please contact OpenReport through the form at the bottom of the <a
